 ...
 /*!
  ...
  QSqlQueryModel * medicament::listeMed_Exp()
  {
      ...
      QSqlQuery query;
       ...
       QSqlQueryModel * model = new QSqlQueryModel();
   model->setQuery("select *from MED where date_exp <= :date  order by nom ");
   query.bindValue(":date",dat.currentDate().toString());
 //  model->setQuery("select *from MED where date_exp like '14-03-2016' or date_exp like '02-03-2018'  or date_exp like '02-03-2019' or date_exp like '27-04-2018'order by nom ");
   model->setHeaderData(0, Qt::Horizontal, QObject::tr("ID"));
   model->setHeaderData(1, Qt::Horizontal, QObject::tr("Nom "));
   model->setHeaderData(2, Qt::Horizontal, QObject::tr("Date Fab"));
   model->setHeaderData(3, Qt::Horizontal, QObject::tr("Date Exp"));
